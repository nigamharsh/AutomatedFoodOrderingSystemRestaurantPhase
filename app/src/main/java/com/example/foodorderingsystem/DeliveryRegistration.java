...
public class DeliveryRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pass = (TextInputLayout)findViewById(R.id.Password2);
        cpass = (TextInputLayout)findViewById(R.id.Confirmpass2);
                                                        ...
                                                        if(task.isSuccessful()){
                                                            ...
                                                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(DeliveryRegistration.this,Delivery_VerifyPhone.class);
